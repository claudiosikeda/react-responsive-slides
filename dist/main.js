...
var StyledSlideContainer = He.div(_templateObject(), function (props) {
  return props.showSlide ? 'scale(1)' : 'scale(0)';
}, function (props) {
  return props.showSlide ? '1' : '0';
});
var StyledImage = He.img(_templateObject2(), function (props) {
  return props.loaded ? '1' : '0';
});
var StyledMedia = He.div(_templateObject3(), function (props) {
  return props.imageHeight;
});
var StyledVideo = He.div(_templateObject4());
var StyledText = He.div(_templateObject5());
var MODAL_SIZE_PERCENT = 80;
var MODAL_PADDING = 140;
var TABLET_SIZE = 768;
var WIDTH_DISCOUNT = 40;
...
var Slide = function Slide(_ref) {
  ...
  var setImageHeight = function setImageHeight() {
    ...
    slideImage.onload = function () {
      ...
      var textHeight = textRef.current ? textRef.current.offsetHeight : 0;
      var modalHeight = windowHeight / 100 * MODAL_SIZE_PERCENT;
      var imgHeight = modalHeight - textHeight - MODAL_PADDING;
      ...
      setHeight(function () {
        if (windowWidth <= TABLET_SIZE) {
          if (slideImage.height > slideImage.width) {
            return "".concat(imgHeight - WIDTH_DISCOUNT, "px");
          }

          return modalHeight < imgHeight ? "".concat(imgHeight, "px") : 'initial';
        }

        return "".concat(imgHeight, "px");
      });
      setLoaded(true);
    };
  };
  ...
  var renderVideo = function renderVideo(src) {
    return /*#__PURE__*/React__default['default'].createElement(StyledMedia, null, /*#__PURE__*/React__default['default'].createElement(StyledVideo, null, /*#__PURE__*/React__default['default'].createElement("iframe", {
      width: "100%",
      height: "100%",
      src: src,
      frameBorder: "0",
  ...
  var renderImage = function renderImage() {
    return /*#__PURE__*/React__default['default'].createElement(StyledMedia, {
      className: "img",
      imageHeight: height
  ...
  var renderSpinner = function renderSpinner() {
    return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, "loading...");
  };

  return /*#__PURE__*/React__default['default'].createElement(StyledSlideContainer, {
    showSlide: current,
    ref: slideRef
  }, /*#__PURE__*/React__default['default'].createElement("div", {
    className: "header"
  }, /*#__PURE__*/React__default['default'].createElement(Header, null)), loaded ? null : renderSpinner(), renderMedia(), renderText(), /*#__PURE__*/React__default['default'].createElement("div", {
    className: "footer"
...
var Mask = He.div(_templateObject$1());
var Viewer = He.div(_templateObject2$1());
var Modal = He.div(_templateObject3$1(), function (props) {
  return props.showModal ? '1' : '0';
});
var MaskModal = He.div(_templateObject4$1(), function (props) {
  return "".concat(props.modalWidth, "px");
}, function (props) {
  return "".concat(props.modalHeight, "px");
});
var Header = He.div(_templateObject5$1());
var Slides = He.ul(_templateObject6());
var Slide$1 = He.li(_templateObject7(), function (props) {
  return props.visible ? 'visible' : 'hidden';
}, function (props) {
  return props.visible ? 'block' : 'fixed';
}, function (props) {
  return props.visible ? '10' : '0';
});
var SlideNav = He.ul(_templateObject8());
var SlideNavItem = He.li(_templateObject9(), function (props) {
  return props.theme.colors.primary;
}, function (props) {
  return props.theme.colors["default"];
});

function Viewer$1(_ref) {
  var originalSlides = _ref.slides,
      header = _ref.header,
      footer = _ref.footer,
      currentSlideIndex = _ref.currentSlideIndex;
  var modalRef = React.useRef();
  var slidesRef = React.useRef();
  ...
  var _useState = React.useState({
    ...
    height: 300
      ...
      _useState2 = _slicedToArray(_useState, 2),
      slideDimensions = _useState2[0],
      setSlideDimentions = _useState2[1];
  ...
  var _useState9 = React.useState([]),
      ...
      slides = _useState10[0],
      setSlides = _useState10[1];

  React.useEffect(function () {
    var withIndex = originalSlides.map(function (item, index) {
  ...
  React.useLayoutEffect(function () {
    if (currentSlide >= 0 && rendered) {
      var nextSlide = slidesRef.current.children[currentSlideIndex];
      if (!nextSlide) return;
  ...
  var renderSlide = function renderSlide(slide) {
    return /*#__PURE__*/React__default['default'].createElement(Slide$1, {
      key: slide.index,
      visible: slide.index === currentSlide
    }, /*#__PURE__*/React__default['default'].createElement(Slide, {
      slide: slide,
  ...
  return /*#__PURE__*/React__default['default'].createElement(Be, {
    theme: {}
  }, /*#__PURE__*/React__default['default'].createElement(Mask, null), /*#__PURE__*/React__default['default'].createElement(Viewer, null, /*#__PURE__*/React__default['default'].createElement(MaskModal, {
    modalWidth: slideDimensions.width,
    modalHeight: slideDimensions.height
  }, rendered ? null : 'Loading...'), /*#__PURE__*/React__default['default'].createElement(Modal, {
    ref: modalRef,
    showModal: rendered,
    className: "modal"
  }, /*#__PURE__*/React__default['default'].createElement(Slides, {
    ref: slidesRef
